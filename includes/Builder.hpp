...
class Builder
{
	...
	public:
		...
		static std::string RplTopic(const std::string &client, const std::string &Channel, const std::string &Topic);
		static std::string RplInviting(const std::string &channel, const std::string &inviterNick, const std::string &invitedNick);
		static std::string RplNamReply(std::string actualClient, std::string ChannelName, std::vector<Client *> _Clients);
		static std::string RplPrivMsg(std::string client, std::string msg, const std::string *ChannelName);
		static std::string RplWhoReply(Channel *Channel, Client *RequestingClient, std::vector<Client *> _Clients);
		static std::string RplLeave(std::string nick,std::string user, std::string ChanName, std::string *msg);
		...
		static std::string RplChannelModeIs(Channel *Channel, std::string ClientName);
		// RPL_NAMREPLY
		// Errors
